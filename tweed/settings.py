...
DATABASES = {
    'default': {
        ...
        'NAME': 'oases',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'j3$5y$lzhd9rkt8@(=i7=axk6!5u_33la59t0477#s0u+cg*^w'
